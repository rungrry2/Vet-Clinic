...
from .models import Bills, Owners, Pets, Appointments, Treatments, Veterinarians, Species, MedicalRecords, Medicines, MedicineStock, PaymentMethod, AppointmentStatus, Suppliers, MedicineStockTransaction, POSTransaction, Users as CustomUsers, Staff
...
def pay_bill(request, id):
    ...
    if request.method == 'POST':
        ...
        if not error:
            ...
            bill.paid_amount = Decimal(str(paid_amount_float))
...
def add_user(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            try:
                # Get or create staff record (needed for ForeignKey)
                staff, created = Staff.objects.get_or_create(
                    staff_id='SYS001',  # System default staff
                    defaults={'staff_name': 'System Administrator'}
                )
